...
import { Person, Lock, PersonAdd, CheckCircle } from '@mui/icons-material';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axiosClient.post<{ token: string }>('/auth/register', {
        username,
        password,
      });
              ...
              <TextField
                ...
                sx={{
                  ...
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&.Mui-focused fieldset': {
                      borderColor: passwordsMatch ? '#4caf50' : '#00BCD4',
                      borderWidth: '2px',
                    },
                  },
                  '& .MuiInputLabel-root': {
                    color: 'rgba(224, 247, 250, 0.7)',
                    '&.Mui-focused': {
                      color: passwordsMatch ? '#4caf50' : '#00BCD4',
                    },
                  },
                }}
              />
